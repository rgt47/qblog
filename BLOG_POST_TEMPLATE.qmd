...
![R Programming - The foundation for data science and statistical computing](images/posts/Rlogo.png){.img-fluid}

*Photo caption with attribution if needed. For CC licensed images: Licensed under [CC BY 2.0](https://creativecommons.org/licenses/by/2.0/) via [Source](https://example.com)*
...
![Summary visualization highlighting main results](images/posts/oop.png){.img-fluid}
