---
title: "A extra simple seven step  process to get your  Shiny app online (securely). "
...
and collaborators. The list of open-source technologies (or stack) we
suggest for employment is: linux, R, Shiny, Caddy, git, and Docker. In
...
Amazon. And in a different vein a howto on preparing dynamic slides for
...
Shiny app we've developed on our local workstation and we'll push it
into the cloud and end with a secure (encrypted and authenticated) app
running on a website with a custom domain name. The approach described
