---
title: "Bare bones process for securely hosting Shiny apps online"
...
```{r out.width="200px"}
include_graphics("img/shinyapppower0.png")
```
...
```{r out.width = "600px"}
include_graphics("img/blogdockerizeflow.png")
...
```{r out.width = "150px"}
include_graphics("img/docker1.jpg")
```
<font size="2"> 
