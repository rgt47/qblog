...
![Foundational concepts and theoretical frameworks](../../images/posts/media/images/penguin-hero.jpg){.img-fluid width=100% style="margin: 2rem 0;"}
...
Okay, so we have 32 cars with 11 variables. Let's see what we're working with here 🤔
...
![Statistical modeling and quantification approaches](../../images/posts/media/images/penguin-hero.jpg){.img-fluid width=100% style="margin: 2rem 0;"}
...
📊 **Nice! The model explains 75% of the variance (R² = 0.75).** For every 1,000 lbs of weight, we lose about 5.3 MPG (95% CI: [-6.5, -4.1]) ✅
...
⚠️ **Diagnostic checks:** Found 2-3 potential outliers (>2.5 SD) when running the analysis.
...
![Synthesis and comprehensive understanding development](../../images/posts/media/images/penguin-hero.jpg){.img-fluid width=100% style="margin: 2rem 0;"}
...
End with 💙 or similar warm closing.
-->
...
- `analysis/paper/index.qmd` - This blog post (narrative only)
...
☐ Structure
  ☐ Introduction with "I didn't know..." hook (2-3 paragraphs)
  ☐ Motivations section (personal reasons)
  ☐ Objectives section (numbered list)
  ☐ Conceptual explanation ("What is X?")
  ☐ Analysis sections with CODE → OUTPUT → INTERPRETATION
  ☐ Summary table of key results
  ☐ Pre-generated figure with caption and alt text
  ☐ Lessons Learnt section (conceptual + technical + gotchas)
  ☐ Limitations (honest assessment)
  ☐ Opportunities for Improvement (future directions)
